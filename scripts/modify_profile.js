...
if (document.getElementById('insegnamenti_container') != null) {
    let insegnamenti = [];
    ...
    let addInsegnamento = document.getElementById('add_insegnamento');

    // Add event listener for the button that adds an insegnamento
    addInsegnamento.addEventListener('click', function (_) {
